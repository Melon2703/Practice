   ...
   return (
       <div>
           <form onSubmit={props.handleSubmit}>
               ...
               {check ?
                   <label onClick={() => setCheck(!check)} style={{color : "lightslategray"}} htmlFor="rememberMe">Запомнить меня</label> :
                   <label onClick={() => setCheck(!check)} style={{color : "deepskyblue"}} htmlFor="rememberMe">Запомнить меня</label>
               }
